              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(color: kAccentCyan.withOpacity(0.4), width: 1),
                          ),
                          child: const Icon(Icons.save_alt, color: kAccentCyan, size: 18),
                        ),
                        const SizedBox(width: 12),
                        Text(
                          t.dialogs.quickSaveNotice.title,
                    ...
                    Text(
                      t.dialogs.quickSaveNotice.content,
